    ...
    <main>
        <div class="container">
            ...
            <div class="text-center">
                <h2 class="show-product-text text-center m-3 shadow-sm p-2">
                    <span><a href="./index.php">Tất cả sản phẩm</a></span>
                    || 
                    <span><a href="./public/new_product.php"></span>Sản phẩm mới</a></span>
                </h2>
